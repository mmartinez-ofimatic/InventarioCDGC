...
namespace InventarioCDGC
{
    public partial class XButton : Button
    {
        ...
        private InventarioCDGC.Theme thm = InventarioCDGC.Theme.MSOffice2010_BLUE;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (thm == InventarioCDGC.Theme.MSOffice2010_BLUE || thm == InventarioCDGC.Theme.MSOffice2010_Green || thm == InventarioCDGC.Theme.MSOffice2010_Yellow || thm == InventarioCDGC.Theme.MSOffice2010_Publisher ||
                thm == InventarioCDGC.Theme.MSOffice2010_RED || thm == InventarioCDGC.Theme.MSOffice2010_WHITE || thm == InventarioCDGC.Theme.MSOffice2010_Pink)
            {
        ...
        public InventarioCDGC.Theme Theme
        {
            get
            {
                if (this.colorTable == Colortable.Office2010Green)
                {
                    return InventarioCDGC.Theme.MSOffice2010_Green;
                }
                else if (this.colorTable == Colortable.Office2010Red)
                {
                    return InventarioCDGC.Theme.MSOffice2010_RED;
                }
                else if (this.colorTable == Colortable.Office2010Pink)
                {
                    return InventarioCDGC.Theme.MSOffice2010_Pink;
                }
                else if (this.colorTable == Colortable.Office2010Yellow)
                {
                    return InventarioCDGC.Theme.MSOffice2010_Yellow;
                }
                else if (this.colorTable == Colortable.Office2010White)
                {
                    return InventarioCDGC.Theme.MSOffice2010_WHITE;
                }
                else if (this.colorTable == Colortable.Office2010Publisher)
                {
                    return InventarioCDGC.Theme.MSOffice2010_Publisher;
                }

                return InventarioCDGC.Theme.MSOffice2010_BLUE;
            }
            ...
            set
            {
                ...
                if (thm == InventarioCDGC.Theme.MSOffice2010_Green)
                {
                    this.colorTable = Colortable.Office2010Green;
                }
                else if (thm == InventarioCDGC.Theme.MSOffice2010_RED)
                {
                    this.colorTable = Colortable.Office2010Red;
                }
                else if (thm == InventarioCDGC.Theme.MSOffice2010_Pink)
                {
                    this.colorTable = Colortable.Office2010Pink;
                }
                else if (thm == InventarioCDGC.Theme.MSOffice2010_WHITE)
                {
                    this.colorTable = Colortable.Office2010White;
                }
                else if (thm == InventarioCDGC.Theme.MSOffice2010_Yellow)
                {
                    this.colorTable = Colortable.Office2010Yellow;
                }
                else if (thm == InventarioCDGC.Theme.MSOffice2010_Publisher)
                {
